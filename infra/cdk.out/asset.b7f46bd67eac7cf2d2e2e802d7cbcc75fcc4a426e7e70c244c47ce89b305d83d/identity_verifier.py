...
class IdentityVerifier:
    ...
    def verify_identity(
        ...
        if rekognition_response_object.face_matches:
            print("Similitud ",rekognition_response_object.face_matches.similarity)
            print("Confianza ",rekognition_response_object.face_matches.confidence)
        elif rekognition_response_object.unmatched_faces:
            print("Confianza ",rekognition_response_object.unmatched_faces.confidence)
