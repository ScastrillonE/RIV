    ...
    def verify_identity(
        ...
        if rekognition_response_object.face_matches:
            return IdentityVerifierResponse(
                similarity=rekognition_response_object.face_matches.similarity,
                reason="Identity verification was successful.",
                confidence=rekognition_response_object.face_matches.confidence,
            )
        elif rekognition_response_object.unmatched_faces:
            return IdentityVerifierResponse(
                similarity=0,
                reason="There are no matches",
                confidence=rekognition_response_object.unmatched_faces.confidence,
            )
