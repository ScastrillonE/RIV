...
class S3EventEntity:
    def __init__(self, event_time, event_name,principal_id, request_id, response_id, bucket_name, object_key):
    ...
    @classmethod
    def from_dict(cls, data: Mapping[str, Any]) -> 'S3EventEntity':
        return cls(
            data['eventTime'],
            data['eventName'],
